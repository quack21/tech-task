                ...
                <div className={styles.modalSettings}>
                  {lists[active].properties.sort(sortCards).map((value, i) => (
                    <div
                      ...
                      <div className={styles.choose} key={value.appellation + '2'}>
                        <svg
                          key={value.appellation + '3'}
                ...
                {lists[active].properties.sort(sortCards).map((value, i) =>
                  value.show === true ? (
                    <div className={styles.tab} key={value.appellation + '6'}>
                      ...
                      <div className={styles.filter} key={value.appellation + '8'}>
                        <svg
                          key={value.appellation + '9'}
                ...
                <>
                  <div className={styles.row} key={value.id + '11'}>
                    {lists[active].properties.sort(sortCards).map((prop) => (
                      <>
                        {prop.show === true ? (
                          <div className={styles.tab} key={value.id + '12'}>
                            <div className={styles.value} key={value.id + '13'}>
                              {value[prop.appellation]}
                            </div>
                          </div>
                        ) : (
                          ''
