        ...
        <div className={styles.new} onClick={() => addNewList()}>
          <svg
            ...
            <path
              ...
              fill="black"
            />
            <path fillRule="evenodd" clipRule="evenodd" d="M48 21H20V19H48V21Z" fill="black" />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              ...
              fill="black"
            />
            <path fillRule="evenodd" clipRule="evenodd" d="M48 29H20V27H48V29Z" fill="black" />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              ...
              fill="black"
            />
            <path fillRule="evenodd" clipRule="evenodd" d="M48 36H20V34H48V36Z" fill="black" />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              ...
              fill="black"
            />
            <path fillRule="evenodd" clipRule="evenodd" d="M48 44H20V42H48V44Z" fill="black" />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
